 ...
 * @version V1.0
 * @Description: 各种状态变量的值
 * @Date 2021/6/22 17:36
 */
public class Status {
    /*====================视频裁剪比例 开始=================================*/
     ...
     * 没有滑动
     */
    public static final int MOVE_NULL = 2000;
    /**
     * 水平滑动
     */
    public static final int MOVE_HORIZONTAL = 2001;
    /**
     * 右侧竖直滑动
     */
    public static final int MOVE_VERTICAL_LEFT = 2002;
    /**
     * 左侧竖直滑动
     */
    public static final int MOVE_VERTICAL_RIGHT = 2003;
}
